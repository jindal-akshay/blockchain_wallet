...
def derive_wallets():
    ...
    for cointype in coin:
        if ETH:
            ...
            command = 'php ..\..\..\..\..\derive -g --mnemonic="erupt sight jealous nation ranch misery bar cancel defense shadow runway waste" --cols=path,address,privkey,pubkey --format=json --numedrive=3 --coin = BTCTEST'
